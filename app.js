...
// Vercel (and most reverse proxies) require trusting proxy headers for secure
// cookies and correct protocol detection.
...
app.use(
    session({
        ...
        cookie: {
            // When behind a proxy (Vercel), this works with app.set("trust proxy", 1)
