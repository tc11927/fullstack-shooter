...
"[project]/components/space-shooter.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SpaceShooter() {
    ...
    const gameRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        player: {
    ...
    const initStars = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpaceShooter.useCallback[initStars]": ()=>{
            const stars = [];
            for(let i = 0; i < 50; i++){
                stars.push({
    ...
    const initEnemies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpaceShooter.useCallback[initEnemies]": (lvl)=>{
            const enemies = [];
    ...
    }["SpaceShooter.useCallback[initEnemies]"], []);
    const startGame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpaceShooter.useCallback[startGame]": ()=>{
    ...
    const nextLevel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpaceShooter.useCallback[nextLevel]": ()=>{
            const game = gameRef.current;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SpaceShooter.useEffect": ()=>{
            ...
            const game = gameRef.current;
            const handleKeyDown = {
                "SpaceShooter.useEffect.handleKeyDown": (e)=>{
                    game.keys[e.key.toLowerCase()] = true;
                    if (e.key === " ") e.preventDefault();
                }
            }["SpaceShooter.useEffect.handleKeyDown"];
            const handleKeyUp = {
                "SpaceShooter.useEffect.handleKeyUp": (e)=>{
                    game.keys[e.key.toLowerCase()] = false;
                }
            }["SpaceShooter.useEffect.handleKeyUp"];
            window.addEventListener("keydown", handleKeyDown);
            window.addEventListener("keyup", handleKeyUp);
            const checkCollision = {
                "SpaceShooter.useEffect.checkCollision": (a, b)=>{
                    return a.x < b.x + b.width && a.x + a.width > b.x && a.y < b.y + b.height && a.y + a.height > b.y;
                }
            }["SpaceShooter.useEffect.checkCollision"];
            const gameLoop = {
                "SpaceShooter.useEffect.gameLoop": ()=>{
                    // Clear
                    ctx.fillStyle = "#0a0a1a";
                    ctx.fillRect(0, 0, GAME_WIDTH, GAME_HEIGHT);
                    // Update and draw stars
                    game.stars.forEach({
                        "SpaceShooter.useEffect.gameLoop": (star)=>{
                            star.y += star.speed;
                    ...
                    game.playerBullets = game.playerBullets.filter({
                        "SpaceShooter.useEffect.gameLoop": (bullet)=>{
                            bullet.y -= 8;
                    ...
                    game.enemies.forEach({
                        "SpaceShooter.useEffect.gameLoop": (enemy)=>{
                    ...
                    // Enemy shooting
                    const aliveEnemies = game.enemies.filter({
                        "SpaceShooter.useEffect.gameLoop.aliveEnemies": (e)=>e.alive
                    }["SpaceShooter.useEffect.gameLoop.aliveEnemies"]);
                    ...
                    game.playerBullets.forEach({
                        "SpaceShooter.useEffect.gameLoop": (bullet, bi)=>{
                            game.enemies.forEach({
                                "SpaceShooter.useEffect.gameLoop": (enemy)=>{
                                    if (!enemy.alive) return;
                                    if (checkCollision(bullet, {
                                        ...
                                        setScore({
                                            "SpaceShooter.useEffect.gameLoop": (s)=>{
                                                const newScore = s + points;
                                                setHighScore({
                                                    "SpaceShooter.useEffect.gameLoop": (h)=>Math.max(h, newScore)
                                                }["SpaceShooter.useEffect.gameLoop"]);
                                                return newScore;
                                            }
                                        }["SpaceShooter.useEffect.gameLoop"]);
                    ...
                    game.enemyBullets.forEach({
                        "SpaceShooter.useEffect.gameLoop": (bullet, bi)=>{
                            if (checkCollision(bullet, playerHitbox)) {
                                ...
                                setLives({
                                    "SpaceShooter.useEffect.gameLoop": (l)=>{
                                        if (l <= 1) {
                ...
                children: [
                    ...
                    gameState === "menu" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            highScore > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(SpaceShooter, "8ZgqlzDhsEfE4TA+OrLKAUkFuQ4=");
_c = SpaceShooter;
var _c;
__turbopack_context__.k.register(_c, "SpaceShooter");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a862e258._.js.map